import {SchemaStore, SchemaValidationError, SpecificationVersion, SchemaWithSpecification} from "./Schemas";
...
export class SchemaRepository {
    ...
    public addSchema(version: SpecificationVersion, schema: JsonSchema): Promise<string> | string {
    ...
    public getSchema(id: string): Promise<SchemaWithSpecification | undefined> | SchemaWithSpecification | undefined {
